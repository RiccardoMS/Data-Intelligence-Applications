...
for el in gts_revenue_per_exp:
  ax1.plot(el, 'b', alpha=0.1)
ax1.plot(np.mean(gts_revenue_per_exp, axis=0), 'k')
...
for el in gpts_revenue_per_exp:
  ax2.plot(el, 'b', alpha=0.1)
ax2.plot(np.mean(gpts_revenue_per_exp, axis=0), 'k')
...
fig, (ax1, ax2) = plt.subplots(1, 2)
ax1.plot(np.cumsum(np.array(gts_arms).reshape(10, T)[0, :]))
ax1.plot(np.cumsum(np.array(gts_arms).reshape(10, T)[1, :]))
ax1.plot(np.cumsum(np.array(gts_arms).reshape(10, T)[2, :]))
ax1.plot(np.cumsum(np.array(gts_arms).reshape(10, T)[3, :]))
ax1.plot(np.cumsum(np.array(gts_arms).reshape(10, T)[4, :]))
ax1.plot(np.cumsum(np.array(gts_arms).reshape(10, T)[5, :]))
ax1.plot(np.cumsum(np.array(gts_arms).reshape(10, T)[6, :]))
ax1.plot(np.cumsum(np.array(gts_arms).reshape(10, T)[7, :]))
ax1.plot(np.cumsum(np.array(gts_arms).reshape(10, T)[8, :]))
ax1.plot(np.cumsum(np.array(gts_arms).reshape(10, T)[9, :]))
ax1.set_xlabel('t')
ax1.set_ylabel('Times')
ax1.legend([str(it) for it in bids])
ax1.set_title('GTS')
ax2.plot(np.cumsum(np.array(gpts_arms).reshape(10, T)[0, :]))
ax2.plot(np.cumsum(np.array(gpts_arms).reshape(10, T)[1, :]))
ax2.plot(np.cumsum(np.array(gpts_arms).reshape(10, T)[2, :]))
ax2.plot(np.cumsum(np.array(gpts_arms).reshape(10, T)[3, :]))
ax2.plot(np.cumsum(np.array(gpts_arms).reshape(10, T)[4, :]))
ax2.plot(np.cumsum(np.array(gpts_arms).reshape(10, T)[5, :]))
ax2.plot(np.cumsum(np.array(gpts_arms).reshape(10, T)[6, :]))
ax2.plot(np.cumsum(np.array(gpts_arms).reshape(10, T)[7, :]))
ax2.plot(np.cumsum(np.array(gpts_arms).reshape(10, T)[8, :]))
ax2.plot(np.cumsum(np.array(gpts_arms).reshape(10, T)[9, :]))
ax2.set_xlabel('t')
ax2.set_ylabel('Times')
ax2.legend([str(it) for it in bids])
ax2.set_title('GPTS')
plt.show()
