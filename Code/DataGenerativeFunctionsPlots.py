...
plt.plot(np.linspace(15, 25, num=1000), [x - 5 - 0.3*x for x in np.linspace(15, 25, num=1000)],'r-')
plt.plot(np.linspace(15, 25, num=1000), [x - 5 -5 for x in np.linspace(15, 25, num=1000)],'g-')
plt.plot(np.linspace(15, 25, num=1000), [x - 5 -(1.5*x/100)*x for x in np.linspace(15, 25, num=1000)],'b-')
plt.xlabel('Price')
