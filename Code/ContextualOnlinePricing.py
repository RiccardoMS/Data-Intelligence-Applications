...
plt.xlabel("t")
plt.ylabel("Regret")
plt.plot(np.cumsum(np.mean(solNew[1] - np.array(ts_revenue_per_experiment), axis=0)), color='darkorange', linewidth=2.5)
plt.plot(np.cumsum(np.mean(solNew[1] - np.array(ucb1_revenue_per_experiment), axis=0)),  color='#0f9b8e', linewidth=2.5)
plt.legend(["TS", "UCB1"])
...
ax1.plot(np.repeat([solNew[1]], T), 'k-', label='Optimal value')
ax1.plot(np.repeat([sol[1]], T), '-', color='#7ebd01', label='Optimal Aggregate')
ax1.set_ylim([0, 1000])
ax1.set_xlabel('t')
...
ax2.plot(np.repeat([solNew[1]], T), 'k-', label='Optimal value')
ax2.plot(np.repeat([sol[1]], T), '-', color='#7ebd01', label='Optimal Aggregate')
ax2.set_ylim([0, 1000])
ax2.set_xlabel('t')
...
for el in ts_contexts_per_experiment:
     ax1.plot(el, 'b--', alpha=0.01, label='_nolegend_')
...
for el in ucb1_contexts_per_experiment:
     ax2.plot(el, 'b--', alpha=0.01, label='_nolegend_')
